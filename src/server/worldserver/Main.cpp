...
char serviceLongName[] = "DscCorePrivate world service";
char serviceDescription[] = "DscCorePrivate World of Warcraft emulator world service";
/*
...
extern int main(int argc, char **argv)
{
    ...
    if (_PACKAGENAME != _PACKAGENAME_ETALON)
    {
        sLog->outError("Invalid or missing config. file : %s", cfg_file);
        sLog->outError("Verify that the file exists and has \'[worldserver]' written in the top of the file!");
        return 1;
    }
    # endif
